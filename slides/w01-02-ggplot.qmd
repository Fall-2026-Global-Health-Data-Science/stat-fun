...
ggplot(
  ...
  geom_point() +
  labs(
    title = "Life expectancy", subtitle="2019"
  )
```
...
> Start with the `lifeexpwide2019` data, map female life expectancy to the x-axis, map male life expectancy to the y-axis, represent each observation with a point, map region to the color of each point, title the plot "Life expectancy," add the subtitle "2019,"
...
ggplot(
  ...
  geom_point() +
  labs(
    title = "Life expectancy", subtitle="2019", x = "Female life expectancy", y = "Male life expectancy"
  )
```
...
> Start with the `lifeexpwide2019` data, map female life expectancy to the x-axis, map male life expectancy to the y-axis, represent each observation with a point, map region to the color of each point, title the plot "Life expectancy," add the subtitle "2019," refine the axis labels, 
...
ggplot(
  ...
  geom_point() +
  labs(
    title = "Life expectancy", subtitle="2019", x = "Female life expectancy", y = "Male life expectancy",color="World Bank Region"
  )
```
...
> Start with the `lifeexpwide2019` data, map female life expectancy to the x-axis, map male life expectancy to the y-axis, represent each observation with a point, map region to the color of each point, title the plot "Life expectancy," add the subtitle "2019," refine the axis labels, fix the legend label, 
...
ggplot(
  ...
  geom_point() +
  labs(
    title = "Life expectancy", subtitle="2019", x = "Female life expectancy", y = "Male life expectancy",color="World Bank Region",caption = "Source: IHME"
  )
```
...
**Oops!** Only **6** shapes are available, so this isn't a good option for our **more than 6** regions!
