...
- **A** is the event that an ant is lightly injured
- **B** is the event that an ant is carried back to the nest
...
- The **union** of A and B, denoted $A \cup B$, is the event that A, or B, or both A and B, occur. Here, $A \cup B$ is the event that an ant is lightly injured, is carried back to the nest, or both.
...
- The **complement** of A, denoted $A^c$ or $\overline{A}$, is the event A does not occur (heavilyly injured, given that all our experiments involved either heavily or lightly injured ants). $A$ and $\overline{A}$ are **mutually exclusive**. 
...
Define events A=lightly injured and B=carried back. Calculate the following probabilities for a randomly-selected injured ant from the study.
