...
- We consider data from IHME on (estimated) infant life expectancy from the years 1990–2019 as a function of location (primarily country) and binary gender.
...
## Summarizing Anscombe's quartet / Datasaurus Dozen

```{r}
#| label: dozen-summary2
#| echo: false
